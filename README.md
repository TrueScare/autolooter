...
|                        | item_random           | /item/random               | Symfony\Component\HttpFoundation\Request <br> App\Service\ProbabilityService                                                                                                                              | site that renders a random item from all items                                                    |
...
| RegistrationController | app_register          | /register                  | Symfony\Component\HttpFoundation\Request <br/>Symfony\Component\PasswordHasher\Hasher\UserPasswordHasherInterface <br/>Doctrine\ORM\EntityManagerInterface <br/> Symfony\Component\Mailer\MailerInterface | registration page                                                                                 |
...
|                        | api_table_move_items  | /api/table/items/from/{id} | Symfony\Component\HttpFoundation\Request <br/> App\Entity\Table <br/>Symfony\Contracts\Translation\TranslatorInterface                                                                                    | renders the modal to move items between tables, if submitted also handles moving the items        |
|                        | api_table_move_tables | /api/table/items/from/{id} | Symfony\Component\HttpFoundation\Request <br/> App\Entity\Table <br/>Symfony\Contracts\Translation\TranslatorInterface                                                                                    | renders the modal to move child tables between tables, if submitted also handles moving the items |
| UserController         | user_edit_self        | /user                      | Symfony\Component\HttpFoundation\Request <br/>Symfony\Contracts\Translation\TranslatorInterface <br/> Symfony\Component\PasswordHasher\Hasher\UserPasswordHasherInterface                                 | page to edit current logged in user information                                                   |
